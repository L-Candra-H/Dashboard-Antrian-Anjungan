...
// kesimpulan ALOS (standar ideal 3–12 hari)
if($ALOS == 0){
    $kesimpulan = "Tidak ada pasien keluar pada periode ini.";
} elseif($ALOS < 3){
    $kesimpulan = "ALOS rendah (<3 hari). Lama rawat terlalu singkat.";
} elseif($ALOS > 12){
    $kesimpulan = "ALOS tinggi (>12 hari). Lama rawat terlalu panjang, perlu evaluasi.";
} else {
    $kesimpulan = "ALOS berada dalam rentang ideal (3–12 hari). Lama rawat optimal.";
}
?>
<!DOCTYPE html>
<html lang="id">
...
<body class="pengajuan">
  ...
  <main class="dashboard">
    <h2 class="anjungan-title">Indikator ALOS (Average Length of Stay)</h2>
    ...
    <div class="stat-box small">
      <div class="stat-item"><strong>ALOS</strong><br><?= number_format($ALOS,2) ?> hari</div>
