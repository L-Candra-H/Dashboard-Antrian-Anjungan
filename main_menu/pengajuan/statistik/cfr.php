...
// --- Kesimpulan ---
if($CFR < 5){
  $kesimpulan = "CFR rendah (<5%). Angka kematian kasus umum masih terkendali.";
} else {
  $kesimpulan = "CFR tinggi (≥5%). Angka kematian kasus umum perlu evaluasi.";
}
...
<body class="pengajuan">
  ...
  <main class="dashboard">
    <h2 class="anjungan-title">Indikator CFR (Case Fatality Rate)</h2>
    ...
    <div class="stat-box small">
      <div class="stat-item"><strong>CFR</strong><br><?= number_format($CFR,2) ?> %</div>
      <div class="stat-item kesimpulan"><strong>Kesimpulan: </strong><?= $kesimpulan ?></div>
    </div>

    <!-- Tabel detail pasien meninggal -->
