...
// jumlah pasien keluar sesuai range
...
// kesimpulan BTO (ideal 40–60 kali per tahun)
if($BTO == 0){
    $kesimpulan = "Tidak ada pasien keluar pada periode ini.";
} elseif($BTO < 40){
    $kesimpulan = "BTO rendah (<40). Tempat tidur jarang digunakan.";
} elseif($BTO > 60){
    $kesimpulan = "BTO tinggi (>60). Tempat tidur terlalu sering berganti pasien.";
} else {
    $kesimpulan = "BTO berada dalam rentang ideal (40–60). Pemanfaatan tempat tidur optimal.";
}
?>
<!DOCTYPE html>
<html lang="id">
...
<body class="pengajuan">
  ...
  <main class="dashboard">
    <h2 class="anjungan-title">Indikator BTO (Bed Turn Over)</h2>
    ...
    <div class="stat-box small">
      <div class="stat-item"><strong>BTO</strong><br><?= number_format($BTO,2) ?></div>
